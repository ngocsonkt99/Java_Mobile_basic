...
public class MainActivity2 extends Activity {
    ...
    ImageView labai1, labai2, labai3, btn;
    TextView tv1;

    int sonut, sonut_player = 0;//de xet xem duoc may nut
    ...
    ImageView mangimg[] = new ImageView[3];
    int manghinhbai[][] = {
            {R.drawable.b2fv,
        ...
        for (int i = 0; i < mangimg.length; i++) {
            ...
            if (i == 2) {
                ...
                if (batay1 == true) {
                    ...
                    chuoikq1 = "Bạn đã bốc được : " + sonut_player + " nút";
